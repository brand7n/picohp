...
/* picoHP compat: replace closure-based reduce with virtual method dispatch */
...
abstract class ParserAbstract implements Parser
{
    ...
    /** @var array<PhpParser\Token> Tokens for the current parse */
    ...
    /**
     * Execute a reduce action. Override in subclass with a switch.
     * Returns true if a reduce action was executed.
     */
    protected function executeReduce(int $rule, int $stackPos): bool
    {
        // Default: no-op. Php8 overrides this with a switch statement.
        return false;
    }
