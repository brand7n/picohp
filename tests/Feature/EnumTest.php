...
it('handles enum case as default parameter', function () {
...
it('handles string-backed enums', function () {
...
it('handles enum methods without explicit return types (defaults to void)', function () {
...
it('handles tryFrom and from on string-backed enums', function () {
    $file = 'tests/programs/classes/enum_tryfrom.php';
