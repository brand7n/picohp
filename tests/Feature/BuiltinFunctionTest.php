...
it('handles fwrite() to standard streams', function () {
    $file = 'tests/programs/functions/builtin_fwrite.php';
...
it('handles preg_match with capture groups', function () {
    $file = 'tests/programs/functions/preg_match.php';
...
it('handles end() on string arrays', function () {
    $file = 'tests/programs/functions/builtins_end_str.php';
...
it('handles is_int and intval', function () {
    $file = 'tests/programs/functions/is_int_intval.php';
...
it('handles preg_match without captures argument', function () {
    $file = 'tests/programs/functions/preg_match_no_captures.php';
...
it('handles is_string, is_float, is_bool type checks', function () {
    $file = 'tests/programs/functions/is_type_checks.php';
...
it('handles array_key_exists on string-keyed maps', function () {
    $file = 'tests/programs/functions/array_key_exists_test.php';
...
it('handles substr with explicit length', function () {
    $file = 'tests/programs/functions/substr_default.php';
