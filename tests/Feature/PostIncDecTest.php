...
it('handles += and -= compound assignment', function () {
    $file = 'tests/programs/operators/plus_minus_equals.php';
...
it('handles += and -= on float values', function () {
    $file = 'tests/programs/operators/plus_minus_equals_float.php';
